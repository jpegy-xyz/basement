...
### Exploring friend.tech: A Dive into Social Token Platforms
...
Friend.tech is a new social token platform that connects your X profile to a wallet on Base chain. Users can buy tokens of other users on the platform that enable the user to connect directly with them in a semi-private chat.

To download friend.tech head to [their website](https://www.friend.tech/) on your phone and follow the prompts. Currently, an app isn't available on the Apple or Google Play stores. You'll also need an invite code to sign up which can be [found on X](https://twitter.com/search?q=friendtech%20code&src=typed_query&f=live). After which you'll have to deposit some eth, which is used to buy keys(tokens) of other users.

<!-- ![Friend.tech codes](p1.png) -->

### What do you mean social tokens?

Social tokens aren't a new concept. They've been tried previously many a time and failed a similar amount of times. They're similar in concept to other tokens like jrny, MVHQ or Underground. Where when you own the token you get access to the thing. The thing here is access to a direct chat with an influencer or other user. You can think of it like a membership to a club, the club being an influencer in this case.

Comparing friend.tech to previous social token ventures is definitely an interesting comparison. Mainly because it paints such an ugly picture. Looking at platforms such as Roll and Rally, We can see Rally didn't perform so well in the long run, and acts as a reminder of what can go wrong in these types of environments. Here's a chart. Not good.

![Rally](p4.png)

It's easy to see a bad chart and write off the whole concept of social token platforms, but let's break it down into challenges and potentials. So that we can understand why these platforms have failed and how they could be beneficial.
...
1. Community Nurturing: A more intimate community-building opportunity for influencers, to connect and interact with their most loyal fans. Creating tangible benefits for their audience, and similarly allowing fans to have close interactions with their preferred influencers.
2. Community Governance: Leveraging the community to be part of governance mechanisms and generally encouraging user participation through airdrops and the like, could boost the popularity of the platform, and see a newer type of social media where the user has a lot more control and influence over how the platform develops.

### Is friend.tech Trustworthy?
...
We can also see the number of key transactions on friend.tech is high, however very very volatile, with interest in the platform waning and growing sporadically. With recent interest booming, can we actually expect it to last? Or even grow into the future?

![market 1](p6.png)

### Are there any market opportunities

There are some market opportunities in friend.tech, however not without risk. More opportunities with less risk do exist if you have an existing social presence or fan base and can broach them onto the platform. 

I urge you to do your own research and not to take this as advice.

Below I list out some of these potential methods, although all have risks to various degrees.

1. friend.tech app speculation
   - You can speculate on the growth of the application by buying tokens(keys) from high-value influencers that can be used as a proxy metric for the overall platform performance. Influencers could include, Racer, Cobie, Haska etc..
2. User speculation
   - Some influencers could be providing more value than others on the platform and as prices are highly volatile and rapidly changing you could see an opportunity where the price of their keys are currently undervalued.
3. New user sniping
...
4. Networking tool
   - friend.tech allows you to connect with some of the most prominent people in the space fairly easily. You can use that to leverage your brand directly to the people you want to reach.
...
6. Farming as a chat influencer
   - Bringing value into the chat incentivises users to buy your tokens.
   - You are then rewarded a percentage of transactions (5%) of key sales, which can yield you a large upside, with less risk than trading other user keys.
...
### What's going on with the airdrop?

Like flies to honey, wherever there's an airdrop there are sure to be crypto degens too. It's a large part of the attraction of friend.tech, airdrop farmers trying to grow their crops for harvest.
...
- Using invite codes.
  - If you don't have anyone to share them with, post them on X with a burner account.
- Holding keys.
  - Weighted by key values.

These points are distributed every Friday.

In short, this could prove to be a good opportunity. The table below table was created by axsn, who did a [solid writeup](https://twitter.com/asxn_r/status/1693280773237805400) into the potential value of the airdrop.
...
2. Influencers and friend.tech stand to gain the most.
...
10. Post airdrop dump. As lots of users are only using friend.tech to farm airdrop points and not for the actual platform itself. After the airdrop is distributed we could see a massive layoff of keys and a sharp decline in prices and an opposite increase in volatility.
